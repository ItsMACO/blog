...
if(mysqli_num_rows($result_seen_times) > 0) {
    echo "<p class='break-long-words'><i class='material-icons'>remove_red_eye</i>&nbsp;Seen ".mysqli_num_rows($result_seen_times)." times.</p>";
} else {
    echo "<p class='break-long-words'><i class='material-icons'>remove_red_eye</i>&nbsp;No one has seen your post yet!</p>";
}
...
if(mysqli_num_rows($result_liked_times) > 0) {
    echo "<p class='break-long-words'><i class='material-icons'>thumb_up</i>&nbsp;Liked ".mysqli_num_rows($result_liked_times)." times.</p>";
} else {
    echo "<p class='break-long-words'><i class='material-icons'>thumb_up</i>&nbsp;No one has liked your post yet!</p>";
}
